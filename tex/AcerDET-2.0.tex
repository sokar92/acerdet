...
The missing transverse energy is calculated by summing up transverse
...
providing particle charge, name, etc. For more details see \newline {\tt AcerDET::core::ParticleDataProvider}.
...
placed in \newline {\tt AcerDET::external::HepMC\_InputConverter}. In order to use 
