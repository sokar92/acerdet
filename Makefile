...
demo:
	$(CC) $(CFLAGS) -c demo.cpp -o demo.o $(PYTHIAINCLUDE) $(HEPMCINCLUDE) -I ./src
	$(CC) $(CFLAGS) -c demoCreateConfig.cpp -o demoCreateConfig.o $(PYTHIAINCLUDE) $(HEPMCINCLUDE) -I ./src
	$(CC) demo.o -o demo.exe $(ACERDET_LIB) $(EXT_LIB) $(PYTHIALIBS) $(HEPMCLIBS) -Wl,-rpath,$(PYTHIALOCATION)lib -Wl,-rpath,$(HEPMCLOCATION)lib
