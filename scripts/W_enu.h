...
// Fri Jul  3 17:18:36 2015 by ROOT version 5.34/30
// from TTree ACDTree/ACDTree
// found on file: new_a-det/pythia.pp.to.W.to.enu.conf.root
//////////////////////////////////////////////////////////
...
#ifdef W_enu_cxx
W_enu::W_enu(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../conf/pythia.pp.to.W.to.enu.conf.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../conf/pythia.pp.to.W.to.enu.conf.root");
      }
...
Int_t W_enu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t W_enu::LoadTree(Long64_t entry)
{
...
void W_enu::Show(Long64_t entry)
{
...
Int_t W_enu::Cut(Long64_t entry)
{
